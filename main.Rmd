...
La régression donne des valeurs proches de 1 (0.88-0.94) avec un R^2>0.88. Ainsi, on a bien une complexité en N! par équivalence avec n*log(n)-n. 
...
Nous obtenons une efficacité supérieure à 85%. Nous pouvons donc supposer au-dela du fait que la structure des classes est bien captées par 
