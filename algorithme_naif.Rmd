...
ca_times <- c(0,0.25,0.53,1.44,2.24,3.74,5.47,6.61,7.8,11.22)

x <- c(10,1010,2010,3010,4010,5010,6010,7010,8010,9010)

data <- data.frame(x = x, y = log(ca_times))

ggplot(data, aes(x = x, y = y)) +
  geom_point() + 
  labs(x = "nb de clusters/classe", y = "log (temps)", title = "")
```
